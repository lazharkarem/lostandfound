...
class SignUpViewController: UIViewController {
    ...
    @IBAction func btnSignupAction(_ sender: Any) {
        if ((self.emailTxtField.text)! != "") && ((self.firstNameTxtField.text)! != "") && ((self.lastNameTxtField.text)! != "") && ((self.passwordTxtField.text)! != "") && ((self.ageTxtField.text)! != "") {
           
            
            
            
            guard let _ = emailTxtField.text , (emailTxtField.text!.isValidEmail()) else {
                 validationFormLabel.text = "Email invalide"
                 return
             }
           ...
           /* guard let _ = ageTxtField.text , (ageTxtField.text?.count)! < 8 else {
            ...
            if ((ageTxtField.text?.count)! != 8){
                validationFormLabel.text = " Le Numéro de Téléphone est invalide "
                
            }
            else  if ((passwordTxtField.text?.count)!  != 4 ){
                validationFormLabel.text = " Mot de passe doit être composé de 4 caractères "
            ...
            validationFormLabel.text = "Verifiez vos donnees"
        }
